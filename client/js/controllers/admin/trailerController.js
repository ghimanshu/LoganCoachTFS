lcControllers.controller('trailerCtrl', ['$scope', '$modal', '$routeParams', '$window', 'TrailerService', 'TrailerConfigService',
  function($scope, $modal, $routeParams, $window, TrailerService, TrailerConfigService) {
